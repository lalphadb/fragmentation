...
export default function StatsDiagonal() {
  ...
  const stats = [
    ...
    {
      value: 0, suffix: "", label: dict.home.stats.accidents,
  ...
  return (
    <section className="bg-orange-400 py-20 md:py-24 relative overflow-hidden" aria-label={dict.home.stats.ariaLabel}>
      {/* Decorative lines */}
