        ...
        <div className="container mx-auto px-6 max-w-3xl relative z-10">
          ...
          <ScrollReveal>
            <div className="mt-16 bg-navy-50 p-10 text-center relative overflow-hidden">
              ...
              <h2 className="text-xl font-black text-navy-900 mb-3">{t.cta.title}</h2>
              <p className="text-navy-500 text-sm mb-8">{t.cta.subtitle}</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href={localePath("/contact", locale)} className="btn-chevron-orange text-sm">{dict.common.cta.contactUs}</Link>
                <Link href={localePath("/soumission", locale)} className="btn-chevron-dark text-sm">{dict.common.cta.requestQuote}</Link>
              </div>
            </div>
          </ScrollReveal>
        </div>
