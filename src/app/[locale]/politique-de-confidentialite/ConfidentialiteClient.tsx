      ...
      <section className="bg-white py-20 md:py-28">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <Section num="01" title="Introduction">
            <p>
              {siteConfig.name} (ci-après &laquo; l&apos;entreprise &raquo;) s&apos;engage à protéger les
          ...
          <Section num="06" title="Consentement">
            <p>
              ...
              à tout moment en utilisant le bouton ci-dessous ou via le lien &laquo;&nbsp;Paramètres cookies&nbsp;&raquo;
