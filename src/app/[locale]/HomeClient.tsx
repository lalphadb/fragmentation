...
export default function HomeClient({ testimonials }: Props) {
  ...
  return (
    <>
      ...
      {/* Testimonials */}
      <section className="bg-white py-24 md:py-32 relative overflow-hidden" aria-label={dict.home.testimonials.label}>
        <div className="container mx-auto px-6 relative z-10">
          <ScrollReveal>
            <div className="text-center mb-16">
              <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">{dict.home.testimonials.label}</span>
              <div className="accent-line mx-auto mb-6" />
              <h2 className="text-4xl md:text-5xl font-black text-navy-950 tracking-tight">{dict.home.testimonials.title}</h2>
            </div>
          </ScrollReveal>
