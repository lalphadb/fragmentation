      ...
      <section className="relative bg-navy-950 text-white min-h-[60vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 py-32 pt-40">
          <div className="max-w-2xl">
            <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block animate-fade-in-up">Notre priorité</span>
            <div className="accent-line mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }} />
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-5 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>Sécurité</h1>
            <p className="text-white/50 text-lg max-w-xl leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              La sécurité n&apos;est pas une option. C&apos;est le fondement de chaque opération que nous réalisons.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-5xl relative z-10">
          ...
          <ScrollReveal>
            <div className="bg-navy-50 p-10 lg:p-14 mb-20 relative overflow-hidden">
              ...
              <h2 className="text-2xl font-black text-navy-900 mb-4">Notre engagement</h2>
              <p className="text-navy-500 leading-relaxed mb-4">
                Chaque opération de dynamitage suit un protocole rigoureux en 8 étapes. De l&apos;évaluation initiale du site jusqu&apos;à l&apos;inspection post-tir, rien n&apos;est laissé au hasard.
              </p>
              <p className="text-navy-500 leading-relaxed">
                Tous nos boutefeux sont certifiés par Ressources naturelles Canada. Nos équipements sont inspectés régulièrement et nos méthodes sont constamment mises à jour.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center mb-14">
              <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Protocole</span>
              <div className="accent-line mx-auto mb-6" />
              <h2 className="text-3xl md:text-4xl font-black text-navy-900 tracking-tight">Nos 8 étapes de sécurité</h2>
            </div>
          </ScrollReveal>
              ...
              <ScrollReveal key={step.id} delay={i * 80} direction={i % 2 === 0 ? "left" : "right"}>
                <div className={`relative flex items-start gap-8 mb-12 ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                  ...
                  <div className={`flex-1 ml-20 md:ml-0 ${i % 2 === 0 ? "md:text-right md:pr-16" : "md:text-left md:pl-16"}`}>
                    <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em]">Étape {String(i + 1).padStart(2, "0")}</span>
          ...
          <ScrollReveal>
            <div className="bg-navy-950 text-white p-10 lg:p-14 text-center relative overflow-hidden">
              <div className="relative z-10">
                <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Certifications</span>
                <h2 className="text-2xl md:text-3xl font-black tracking-tight mb-3">Conformité et certifications</h2>
                <p className="text-white/50 mb-8 max-w-lg mx-auto text-sm leading-relaxed">
                  Licence RBQ valide, boutefeux certifiés, assurance responsabilité civile complète. Nous respectons toutes les réglementations en vigueur.
                </p>
                <Link href="/contact" className="btn-chevron-orange">Des questions sur la sécurité?</Link>
              </div>
            </div>
          </ScrollReveal>
        </div>
