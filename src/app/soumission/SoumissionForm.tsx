...
const STEPS = ["Type de projet", "Localisation", "Détails", "Coordonnées"];
        ...
        <section className="relative bg-navy-950 text-white min-h-[60vh] flex items-center overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 py-32 pt-40">
            <div className="max-w-2xl">
              <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Confirmé</span>
              <div className="accent-line mb-6" />
              <h1 className="text-5xl font-black tracking-tight">Soumission envoyée!</h1>
            </div>
          </div>
        ...
        <section className="bg-white py-24 md:py-32">
          <div className="container mx-auto px-6 max-w-xl">
            <div className="bg-navy-50 p-10 text-center relative overflow-hidden">
              ...
              <h2 className="text-xl font-black text-navy-900 mb-3">Merci pour votre demande!</h2>
  ...
  return (
    <>
      ...
      <section className="relative bg-navy-950 text-white min-h-[60vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 py-32 pt-40">
          <div className="max-w-2xl">
            <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block animate-fade-in-up">Gratuit et sans engagement</span>
            <div className="accent-line mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }} />
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-5 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>Demander une soumission</h1>
          ...
          <form onSubmit={handleSubmit} className="bg-navy-50 p-6 md:p-10">
            ...
            {step === 1 && (
              <div className="space-y-6">
                <div>
                  <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Étape 01</span>
                  <h2 className="text-lg font-black text-navy-900 mb-6">Type de projet</h2>
                </div>
                <div>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div>
                  <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Étape 02</span>
                  <h2 className="text-lg font-black text-navy-900 mb-6">Localisation du projet</h2>
                </div>
                <div>
            ...
            {step === 3 && (
              <div className="space-y-6">
                <div>
                  <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Étape 03</span>
                  <h2 className="text-lg font-black text-navy-900 mb-6">Détails du projet</h2>
                </div>
                <div>
            ...
            {step === 4 && (
              <div className="space-y-6">
                <div>
                  <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Étape 04</span>
                  <h2 className="text-lg font-black text-navy-900 mb-6">Vos coordonnées</h2>
                </div>
                <div>
