      ...
      <section className="relative bg-navy-950 text-white min-h-[60vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 py-32 pt-40">
          <div className="max-w-2xl">
            <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block animate-fade-in-up">Ce que nous offrons</span>
            <div className="accent-line mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }} />
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-5 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>Nos services</h1>
            <p className="text-white/50 text-lg max-w-xl leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              Solutions complètes de forage et dynamitage adaptées à chaque type de projet.
            </p>
          </div>
        </div>
        {/* Angled bottom */}
          ...
          <ScrollReveal>
            <div className="mt-24 bg-navy-950 text-white p-12 lg:p-16 text-center relative overflow-hidden">
              <div className="relative z-10">
                <span className="text-orange-400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Sur mesure</span>
                <h2 className="text-2xl md:text-4xl font-black tracking-tight mb-4">Besoin d&apos;un service sur mesure?</h2>
                <p className="text-white/50 mb-8 max-w-lg mx-auto">Chaque projet est unique. Contactez-nous pour discuter de vos besoins spécifiques.</p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/soumission" className="btn-chevron-orange">Demander une soumission</Link>
                  <Link href="/contact" className="btn-chevron-outline">Nous contacter</Link>
                </div>
              </div>
            </div>
          </ScrollReveal>
